...
image_name = "test_piece"
img_counter=0

print('read an image from file')
color_image = cv2.imread("../../images/test_piece_0.png",cv2.IMREAD_COLOR)
...
img_name = "test_piece_{}_saturation.png".format(img_counter)
util.capture_frame(s, img_name, img_counter)
...
img_name = "test_piece_{}_gray.png".format(img_counter)
util.capture_frame(gray_image, img_name, img_counter)
